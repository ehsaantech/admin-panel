...
export const metadata: Metadata = {
  title: "ET Admin Panel SignUp Page"
};

const SignUp: React.FC = () => {
  return (
    <>
      <div className="container mx-auto mt-20 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                <h1 className="text-2xl font-bold text-black dark:text-white sm:text-title-xl2">ET ADMIN PANEL</h1>
              </Link>
              <p className="2xl:px-20">Your Technology Consulting Partner.</p>
